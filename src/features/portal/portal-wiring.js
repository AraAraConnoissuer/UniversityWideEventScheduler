// Feature copy of virtual module: portal-wiring.js
...
function loginAreaHref() {
  if (document.body.dataset.dashboard === 'organization') return 'index.html';
  ...
  return user?.role === 'super_admin' ? 'admin-dashboard.html' : 'index.html';
}
