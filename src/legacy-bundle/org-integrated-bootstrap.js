...
async function startDashboard(store) {
  ...
  await import('./calendar-logic-guard.js?v=20260625-start-end-dates-v6');await import('./portal-logic-fixes.js?v=20260625-org-announcements-v1');await waitForFullCalendar();await import('./script.js?v=20260625-org-announcements-v1');await import('./portal-wiring.js?v=20260625-concerns-sync-v1');await importOptionalDashboardModule('./activity-status-bridge.js?v=20260625-profile-status-v3');await importOptionalDashboardModule('./ui-light-cards.js?v=20260625-org-announcements-v1');await importOptionalDashboardModule('./portal-ui-polish.js?v=20260625-org-announcements-v1');await importOptionalDashboardModule('./responsive-system.js?v=20260908-responsive-system-v1');await importOptionalDashboardModule('./conference-room-booking.js?v=20260812-conference-room-db-v4')
}
